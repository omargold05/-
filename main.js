    ...
    logic: [
        {
            id: 1,
            title: "لغز الأوزان",
            description: "لديك 9 كرات متماثلة في الشكل، لكن واحدة منها أخف قليلاً من الباقي. كيف يمكنك معرفة الكرة الأخف باستخدام الميزان ذو الكفتين مرتين فقط؟",
            type: "multiple",
            options: [
                "تقسيم الكرات إلى 3 مجموعات (3،3،3) ووزن مجموعتين",
                "وزن كل كرة على حدة حتى تجد الأخف",
                "تقسيم الكرات إلى مجموعتين (4،5) ووزن المجموعتين",
                "لا يمكن معرفتها بمرتين فقط"
            ],
            correctAnswer: 0,
            difficulty: "medium",
            points: 15,
            hint: "جرب تقسيم الكرات إلى 3 مجموعات متساوية. تذكر أن لديك ميزانًا بكرتين فقط.",
            solution: "1. قسم الكرات إلى 3 مجموعات (أ، ب، ج) كل مجموعة تحتوي على 3 كرات.\n2. ضع المجموعة أ على كفة والمجموعة ب على الكفة الأخرى:\n   - إذا تساوت الكفتان: الكرة الأخف في المجموعة ج\n   - إذا مال الميزان: الكرة الأخف في الكفة الأخف\n3. خذ المجموعة التي تحتوي على الكرة الأخف (3 كرات) ووزن كرتين منها:\n   - إذا تساوت: الكرة الثالثة هي الأخف\n   - إذا مال: الكرة الأخف هي في الكفة الأخف"
        },
        {
            id: 2,
            title: "لغز الجسور السبعة",
            description: "في مدينة كونيجسبرغ يوجد نهر به جزيرتان متصلتان ببعضهما وبالضفتين بسبعة جسور. هل يمكنك السير في جميع الجسور مرة واحدة فقط دون تكرار أي جسر؟",
            type: "multiple",
            options: [
                "نعم، من أي نقطة تبدأ",
                "لا، مستحيل رياضياً",
                "نعم، ولكن من نقاط محددة فقط",
                "يعتمد على سرعة السير"
            ],
            correctAnswer: 1,
            difficulty: "hard",
            points: 20,
            hint: "هذه مشكلة رياضية كلاسيكية تتعلق بنظرية المخططات.",
            solution: "هذه هي مشكلة جسور كونيجسبرغ الشهيرة. أثبت أويلر رياضياً أنه لا يمكن السير في جميع الجسور مرة واحدة فقط دون تكرار أي جسر. الحل يتطلب أن يكون لكل منطقة عدد زوجي من الجسور الواصلة إليها، وهو ما لا ينطبق هنا."
        }
    ],
    math: [
        {
            ...
            description: "في متتالية فيبوناتشي: 1, 1, 2, 3, 5, 8, 13, 21, ... ما هو العدد الذي يلي 21؟",
            type: "open",
            correctAnswer: "34",
            difficulty: "easy",
            points: 10,
            hint: "كل عدد في المتتالية هو مجموع العددين السابقين له.",
            solution: "21 + 13 = 34"
        }
    ],
    memory: [
        {
            ...
            description: "انظر إلى التسلسل التالي لمدة 10 ثوانٍ، ثم حاول تذكره: 🔴 🔵 🟢 🟡 🔴 🟢 🔵 🟡",
            type: "multiple",
            options: [
                "🔴 🔵 🟢 🟡 🔴 🟢 🔵 🟡",
                "🔴 🔵 🟡 🟢 🔴 🟢 🔵 🟡",
            ...
            difficulty: "medium",
            points: 12,
            hint: "ركز على الألوان وترتيبها بدلاً من الأشكال.",
            solution: "التسلسل الصحيح هو: 🔴 🔵 🟢 🟡 🔴 🟢 🔵 🟡"
        }
    ],
    language: [
        {
            id: 5,
            title: "كلمة السر",
            description: "ما هي الكلمة العربية التي إذا قرأتها من اليمين إلى اليسار أو من اليسار إلى اليمين تبقى كما هي؟",
            type: "open",
            correctAnswer: "توت",
            difficulty: "easy",
            points: 8,
            hint: "تتكون من 3 حروف.",
            solution: "كلمة 'توت' تقرأ نفسها من الجهتين."
        }
    ]
};
